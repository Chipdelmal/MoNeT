...
pathRoot = "/Volumes/marshallShare/ERACR/Yorkeys_MINI/LandAggregated"
firstRun = True


# clusterFile = sorted(glob.glob(pathRoot+'/*/Yorkeys*I.csv'))[1]
...
###############################################################################
for clusterFile in sorted(glob.glob(pathRoot+'/C000500/Yorkeys*I.csv')):
    clusterstr = clusterFile.split('/')[-2][1:]
