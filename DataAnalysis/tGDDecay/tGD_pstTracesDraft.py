...
###########################################################################
# Using 'i' temporarily so that it can be tested easily
i = 3
repFile = sorted(repFiles)[i]
...
# NOTE: I think the WOP here already seems to have what we need to add to the
#       plot!!!!!
