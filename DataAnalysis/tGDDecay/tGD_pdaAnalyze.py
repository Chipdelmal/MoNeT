...
ttiR = pkl.load('/media/hdd/WorkExperiments/tGD/figure2/tGD/000/SUMMARY/HLT_TTI_{}_mlr.bz'.format(QNT))
ttiR.keys()
ttiR[(5, 75, 5, 90, 2, 100, 0)][int(QNT)] # These ID numbers come from the fName
