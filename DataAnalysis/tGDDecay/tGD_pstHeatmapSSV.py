...
for (xpNumC, xpId) in enumerate(idTuples):
    ...
    cc = ax.contour(xi, yi, zi, levels=lvls, linewidths=1, colors='k', alpha=.5)
    ...
    # Grid
    ax.grid(which='both', axis='y', lw=.1, alpha=1, color=(0, 0, 0))
    ax.grid(which='both', axis='x', lw=.1, alpha=1, color=(0, 0, 0))
    # Title
