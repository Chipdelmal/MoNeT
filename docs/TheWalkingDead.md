...
As a first approximation, we are using an extremely rough approximation of the mosquito probability of choosing a site based on the inverse of the Euclidean distance between sites ($$\Tau=1/distancesMatrix$$). This, as we will see later, is not an accurate representation of the real phenomena, but will be improved later on.
...
<ul>
  <li>Start with our uniform transitions matrix $$\Tau$$.</li>
...
<img src="./media/MS_01.jpg" width="30%"><img src="./media/MS_02.jpg" width="30%"><img src="./media/MS_03.jpg" width="27.5%">
<img src="./media/MS_04.jpg" width="30%"><img src="./media/MS_05.jpg" width="30%"><img src="./media/MS_06.jpg" width="30%">
